...
SONGS_DATABASE = {
    ...
    "The last talk": {
        ...
        "lyrics_timed": [
            {"time": 0.0, "text": "......."},
            {"time": 25.5, "text": "Sun maa..."},
            {"time": 27.2, "text": "Dekh phasta ja raha hoon"},
            {"time": 29.5, "text": "Duniya ke daldal mein"},
            {"time": 30.5, "text": "Dhasta ja raha hoon"},
            {"time": 31.2, "text": "Daba ke rakhun gham..."},
            {"time": 33.0, "text": "Bata kitne dil mein hai"},
            {"time": 35.2, "text": "Aankhon mein aansu"},
            {"time": 36.8, "text": "Aur hasta ja raha hoon"},
            {"time": 38.0, "text": "Main chahta to tha tujhe"},
            {"time": 39.0, "text": "Sab kuch bata dun"},
            {"time": 40.0, "text": "Laga ke gale"},
            {"time": 41.5, "text": "Sare gham main bhula dun"},
            {"time": 43.5, "text": "Teri aankhon mein aanshu bhate nahi"},
            {"time": 45.5, "text": "Mujhe behtar laga ke"},
            {"time": 47.2, "text": "Main khud ko sula dun"},
            {"time": 48.5, "text": "Tu reh lena mere jaane ke baad"},
            {"time": 50.0, "text": "Zyada na rona mar jaane ke baad"},
            {"time": 53.0, "text": "Has-has ke karna vida mujhko duniya se"},
            {"time": 56.2, "text": "Photo tu lena janaze ke sath"},
            {"time": 59.0, "text": "Dikhane the sath ajube jahan ke"},
            {"time": 61.2, "text": "Dikha bhi na paya, bata bhi na paya"},
            {"time": 64.0, "text": "Batani thi tujhko maa baatein bahut si"},
            {"time": 67.0, "text": "Main kismat ka mara bata bhi na paya"},
            {"time": 69.9, "text": "Saja bhi na paya ma duniya teri"},
            {"time": 72.0, "text": "Teri raahon se kante hata bhi na paya"},
            {"time": 75.0, "text": "Likha tha ek khat bas tere liye"},
            {"time": 77.0, "text": "Tujhe paas bitha ke suna bhi na paya"},
            {"time": 81.0, "text": "......."},
            {"time": 91.0, "text": "Likha tha ek khat bas tere liye"},
            {"time": 93.5, "text": "Tujhe paas bitha ke suna bhi na paya"},
            {"time": 96.0, "text": "Maa main aaunga lekar janam phir dubara"},
            {"time": 99.5, "text": "Main kabil banunga sab hasil karunga"},
            {"time": 102.0, "text": "Tu banna meri maa phir ek janam aur"},
            {"time": 105.5, "text": "Main kabil hoon kitna main sabit karunga"},
            {"time": 107.5, "text": "Tere hisse ke gham main lekar chala"},
            {"time": 110.0, "text": "Mere jaane ke baad tu rona na na"},
            {"time": 112.0, "text": "Mujhe pata hai tu kitna marti hai mujhpe"},
            {"time": 115.5, "text": "Paas photo ko rakh ke tu sona na na"},
            {"time": 118.0, "text": "Tune jhopdi ko ghar banaya hai maa"},
            {"time": 120.5, "text": "Tapti dhoop mein khud ko tapaya hai maa"},
            {"time": 122.8, "text": "Log izzat ya paisa ek hi kamate hain"},
            {"time": 126.0, "text": "Tune to dono kamaya hai maa"},
            {"time": 129.0, "text": "Maa poochti hai to main batata nahi"},
            {"time": 131.0, "text": "Koi bole bhi aur jawab na de"},
            {"time": 134.0, "text": "Uski aankhon mein dekh ke lagta hai mujhko"},
            {"time": 136.8, "text": "Khuda mujh si kisi ko aulaad na de"},
            {"time": 140.0, "text": "Main jitna lad sakta tha khud se lada"},
            {"time": 144.0, "text": "Maa main khud se to jeet gaya magar zindagi se haar gaya"},
            {"time": 148.0, "text": "Mujhe khali jeb aur gareebi ne nahi mara"},
            {"time": 151.0, "text": "Maa tera chhup-chhup ke rona maar gaya"},
            {"time": 154.9, "text": "Maa tera chhup-chhup ke rona maar gaya"},
            {"time": 157.0, "text": "....end😭..."}
        ]
    }
}
