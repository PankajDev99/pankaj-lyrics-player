...
SONGS_DATABASE = {
    ...
    {"time": 27.0, "text": "Dekh phasta ja raha hoon"},
    ...
    {"time": 36.5, "text": "Aankhon mein aansu"},
    {"time": 38.0, "text": "Aur hasta ja raha hoon"},
    {"time": 39.8, "text": "Main chahta to tha tujhe"},
    {"time": 41.5, "text": "Sab kuch bata dun"},
    {"time": 43.0, "text": "Laga ke gale"},
    {"time": 44.5, "text": "Sare gham main bhula dun"},
    {"time": 47.0, "text": "Teri aankhon mein aanshu bhate nahi"},
    {"time": 49.5, "text": "Mujhe behtar laga ke"},
    {"time": 51.5, "text": "Main khud ko sula dun"},
    {"time": 53.5, "text": "Tu reh lena mere jaane ke baad"},
    {"time": 56.0, "text": "Zyada na rona mar jaane ke baad"},
    {"time": 59.0, "text": "Has-has ke karna vida mujhko duniya से"},
    {"time": 62.0, "text": "Photo tu lena janaze ke sath"},
    {"time": 65.5, "text": "Dikhane the sath ajube jahan ke"},
    {"time": 68.2, "text": "Dikha bhi na paya, bata bhi na paya"},
    {"time": 71.5, "text": "Batani thi tujhko maa baatein bahut si"},
    {"time": 74.8, "text": "Main kismat ka mara bata bhi na paya"},
    {"time": 77.8, "text": "Saja bhi na paya ma duniya teri"},
    {"time": 80.5, "text": "Teri raahon se kante hata bhi na paya"},
    {"time": 83.8, "text": "Likha tha ek khat bas tere liye"},
    {"time": 86.2, "text": "Tujhe paas bitha ke suna bhi na paya"},
    {"time": 90.0, "text": "......."},
    {"time": 131.5, "text": "Likha tha ek khat bas tere liye"},
    {"time": 134.0, "text": "Tujhe paas bitha ke suna bhi na paya"},
    {"time": 136.8, "text": "Maa main aaunga lekar janam phir dubara"},
    {"time": 140.0, "text": "Main kabil banunga sab hasil karunga"},
    {"time": 143.0, "text": "Tu banna meri maa phir ek janam aur"},
    {"time": 146.2, "text": "Main kabil hoon kitna main sabit karunga"},
    {"time": 148.5, "text": "Tere hisse ke gham main lekar chala"},
    {"time": 151.0, "text": "Mere jaane ke baad tu rona na na"},
    {"time": 153.8, "text": "Mujhe pata hai tu kitna marti hai mujhpe"},
    {"time": 157.2, "text": "Paas photo ko rakh ke tu sona na na"},
    {"time": 160.0, "text": "Tune jhopdi ko ghar banaya hai maa"},
    {"time": 163.0, "text": "Tapti dhoop mein khud ko tapaya hai maa"},
    {"time": 166.0, "text": "Log izzat ya paisa ek hi kamate hain"},
    {"time": 169.5, "text": "Tune to dono kamaya hai maa"},
    {"time": 172.5, "text": "Maa poochti hai to main batata nahi"},
    {"time": 175.5, "text": "Koi bole bhi aur jawab na de"},
    {"time": 178.5, "text": "Uski aankhon mein dekh ke lagta hai mujhko"},
    {"time": 182.0, "text": "Khuda mujh si kisi ko aulaad na de"},
    {"time": 186.0, "text": "Main jitna lad sakta tha khud se lada"},
    {"time": 190.5, "text": "Maa main khud se to jeet gaya magar zindagi se haar gaya"},
    {"time": 196.0, "text": "Mujhe khali jeb aur gareebi ne nahi mara"},
    {"time": 200.0, "text": "Maa tera chhup-chhup ke rona maar gaya"},
    {"time": 205.0, "text": "Maa tera chhup-chhup ke rona maar gaya"},
    {"time": 210.0, "text": "......."},
    {"time": 253.0, "text": "I love you maa"}
]
    }
}
